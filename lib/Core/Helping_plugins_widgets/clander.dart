    ...
    return Scaffold(
      body: TableCalendar(
        ...
        calendarStyle: CalendarStyle(
          todayDecoration:
              BoxDecoration(color: baseColor2, shape: BoxShape.circle),
          selectedDecoration:
              BoxDecoration(color: baseColor, shape: BoxShape.circle),
        ),
        calendarFormat: _calendarFormat,
        selectedDayPredicate: (day) {
          return isSameDay(TableBasicsExample.selectedDay, day);
        },
        ...
        onDaySelected: (selectedDay, focusedDay) {
          if (!isSameDay(TableBasicsExample.selectedDay, selectedDay)) {
            setState(() {
              TableBasicsExample.selectedDay = selectedDay;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TableCalendar(
        ...
        calendarStyle: CalendarStyle(
          selectedTextStyle: TextStyle(color: baseColor),
          // rangeHighlightColor: greenColor,
        ...
        headerStyle: HeaderStyle(
          formatButtonVisible: false,
          formatButtonShowsNext: false,
          formatButtonPadding: EdgeInsets.symmetric(horizontal: 100.w),
          titleCentered: true, // centerHeaderTitle: true,
          // formatButtonVisible: false,
        ),
        onPageChanged: (focusedDay) {
          _focusedDay = focusedDay;
